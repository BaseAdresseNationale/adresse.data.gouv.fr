...
const types = [
  ...
  {name: 'toponyme', background: '#1E90DA', color: 'white', priority: 9},
  {name: 'local-commun', background: '#00B5AD', color: 'white', priority: 10},
  {name: 'divers', background: '#DDDDDD', color: 'black', priority: 11}
]
