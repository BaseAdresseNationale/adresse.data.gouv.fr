...
import {getStatus, getName, hasPosition, getNumeroPosition, getPosition} from './bal/item'
...
export function numeroPositionsToGeoJson(numero) {
  return {
    type: 'FeatureCollection',
    features: numero.positions.map(position => positionToFeature(position, numero))
  }
}
