...
export const {NEXT_PUBLIC_API_BAN_URL: API_BAN_URL} = getConfig().publicRuntimeConfig
...
export function getAdressesCsvBal(codeCommune, version = '1.3') {
  return `${API_BAN_URL}/ban/communes/${codeCommune}/download/csv-bal/adresses?version=${version}`
}
