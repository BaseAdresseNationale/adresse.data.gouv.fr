...
describe('BAL', () => {
  ...
  describe('createVoie', () => {
    ...
    test('should create a toponyme', async () => {
      const bal = new BAL(TREE)
      const voie = {
        codeVoie: '2',
        nomVoie: 'voie2',
      ...
      expect(await bal.createVoie('1', {codeVoie: '2', nomVoie: 'voie2', position: []})).toEqual(voie)
      expect(await bal.getVoie('1', '2')).toEqual(voie)
    })
  ...
  describe('deleteCommune', () => {
    ...
    test('should remove commune from BAL when "created" is true', async () => {
      ...
      expect(await bal.getCommune('2')).toBeUndefined()
    })
  ...
  describe('deleteVoie', () => {
    ...
    test('should remove voie from BAL when "created" is true', async () => {
      ...
      expect(await bal.getVoie('1', '2')).toBeUndefined()
    })
  ...
  describe('deleteNumero', () => {
    ...
    test('should remove numero from BAL when "created" is true', async () => {
      ...
      expect(await bal.getNumero('1', '1', '2')).toBeUndefined()
    })
  ...
  describe('updateNumero', () => {
    test('should set changes to numero', async () => {
      const bal = new BAL(TREE)
      const modified = {numeroComplet: '123', dateMAJ: TODAY}
