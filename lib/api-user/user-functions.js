...
async function renewPasswordToken(req, res) {
  ...
  if (user && !user.isDeleted) {
    ...
    const mailOptions = {
      ...
      text: `Bonjour ${user.firstName}, pour modifier votre mot de passe, merci de cliquer sur ce lien : ${process.env.SITE_URL}/api-users/renew-password?token=${token.token}`
    }
