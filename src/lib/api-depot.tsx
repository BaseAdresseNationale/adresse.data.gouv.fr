...
export const getRevisionDetails = async (revision: Revision, commune: BANCommune) => {
  ...
  return [
    revision.current ? <Tooltip message="Révision courante"><span className="fr-icon-success-line" aria-hidden="true" /></Tooltip> : '',
    ...
    modeDePublication,
    source,
    <a className="fr-btn" key={revision._id} href={getRevisionDownloadUrl(revision._id)} download><span className="fr-icon-download-line" aria-hidden="true" /></a>,
  ]
}
