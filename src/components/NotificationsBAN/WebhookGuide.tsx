...
interface WebhookGuideProps {
  alwaysExpanded?: boolean
}

export default function WebhookGuide({ alwaysExpanded = false }: WebhookGuideProps) {
  ...
  if (alwaysExpanded) {
    return (
      <div className="fr-mb-3w" data-guide-container>
        <h3>Guide d'utilisation - Comprendre et configurer les webhooks</h3>
        {guideContent}
      </div>
    )
  }
