...
interface CandidacyInfosProps {
  onConfirm: () => void
}

function CandidacyInfos({ onConfirm }: CandidacyInfosProps) {
  return (
    <div>
      <p>
