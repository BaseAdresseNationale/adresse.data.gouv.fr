      ...
      <div className="entrypoint" id="search">
        <div className="row">
          ...
          <div className="details">
            ...
            <Code code="curl &quot;https://api-adresse.data.gouv.fr/search/?q=8+bd+du+port&quot;" />
            <p>Avec <b>limit</b> on peut contrôler le nombre d’éléments retournés:</p>
            <Code code="curl &quot;https://api-adresse.data.gouv.fr/search/?q=8+bd+du+port&limit=15&quot;" />
            <p>Avec <b>autocomplete</b> on peut désactiver les traitements d’auto-complétion:</p>
            <Code code="curl &quot;https://api-adresse.data.gouv.fr/search/?q=8+bd+du+port&autocomplete=0&quot;" />
            <p>Avec <b>lat</b> et <b>lon</b> on peut donner une priorité géographique:</p>
            <Code code="curl &quot;https://api-adresse.data.gouv.fr/search/?q=8+bd+du+port&lat=48.789&lon=2.789&quot;" />
            <p>Les filtres <b>type</b>, <b>postcode</b> (code Postal) et <b>citycode</b> (code INSEE) permettent de restreindre la recherche:</p>
            <Code code="curl &quot;https://api-adresse.data.gouv.fr/search/?q=8+bd+du+port&postcode=44380&quot;" />
            <Code code="curl &quot;https://api-adresse.data.gouv.fr/search/?q=paris&type=street&quot;" />
      ...
      <div className="entrypoint" id="reverse">
        <div className="row">
          ...
          <div className="details">
            ...
            <Code code="curl &quot;https://api-adresse.data.gouv.fr/reverse/?lon=2.37&lat=48.357&quot;" />
            <p>Le paramètre <b>type</b> permet forcer le type de retour:</p>
            <Code code="curl &quot;https://api-adresse.data.gouv.fr/reverse/?lon=2.37&lat=48.357&type=street&quot;" />
      ...
      <div className="entrypoint" id="csv-search">
        <div className="row">
          ...
          <div className="details">
            ...
            <Code code="curl -X POST -F data=@path/to/file.csv https://api-adresse.data.gouv.fr/search/csv/" />
            ...
            <Code code="curl -X POST -F data=@path/to/file.csv -F columns=voie -F columns=ville https://api-adresse.data.gouv.fr/search/csv/" />
            ...
            <Code code="curl -X POST -F data=@path/to/file.csv -F columns=voie -F columns=ville -F citycode=ma_colonne_code_insee https://api-adresse.data.gouv.fr/search/csv/" />
            <Code code="curl -X POST -F data=@path/to/file.csv -F columns=voie -F columns=ville -F postcode=colonne_code_postal https://api-adresse.data.gouv.fr/search/csv/" />
            ...
            <Code code="curl -X POST -F data=@search.csv -F columns=adresse -F columns=postcode https://api-adresse.data.gouv.fr/search/csv/" />
            ...
            <Code code="curl -X POST -F data=@search.csv -F columns=adresse -F columns=postcode -F result_columns=result_id -F result_columns=result_score https://api-adresse.data.gouv.fr/search/csv/" />
          </div>
        </div>
      </div>
      <div className="entrypoint" id="csv-reverse">
        <div className="row">
          ...
          <div className="details">
            ...
            <Code code="curl -X POST -F data=@path/to/file.csv https://api-adresse.data.gouv.fr/reverse/csv/" />
