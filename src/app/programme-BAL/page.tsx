        ...
        <div className="fr-container fr-py-5w">
          <div className="fr-grid-row">
            <div className="fr-col-md-7 improve-quality-card">
              <h1 className="fr-mb-3w">Améliorez la qualité de service de vos administrés</h1>
              <p style={{ marginBottom: 40 }} className="fr-text--lead fr-pr-3w"><b>Bases Adresses Locales</b> est un programme de l&apos;ANCT destiné aux communes. Référencez toutes les adresses de votre commune pour offrir de meilleurs services à vos administrés.</p>
              <Button linkProps={{
        ...
        <div className="fr-container fr-py-5w">
          <div className="fr-grid-row fr-grid-row--gutters">
            <div className="fr-illu fr-col-12 fr-col-md-4 align-center">
              <Image src="/programme-bal/ludique.svg" alt="icone carte" width={72} height={72} />
              <h4>Ludique</h4>
              <p>Redécouvrez votre commune autrement</p>
            </div>
            <div className="fr-illu fr-col-12 fr-col-md-4 align-center">
              <Image src="/programme-bal/a-votre-rythme.svg" alt="icone carte" width={72} height={72} />
              <h4>À votre rythme</h4>
              <p>Complétez votre base en plusieurs temps</p>
            </div>
            <div className="fr-illu fr-col-12 fr-col-md-4 align-center">
              <Image src="/programme-bal/simple.svg" alt="icone carte" width={72} height={72} />
              <h4>Simple</h4>
        ...
        <div className="fr-container fr-py-5w">
          ...
          <div className="fr-grid-row space-between-row">
            <div className="fr-col-md-5 verbatim-card">
              <Image src="/programme-bal/verbatim.svg" alt="icone verbatim" width={30} height={30} />
