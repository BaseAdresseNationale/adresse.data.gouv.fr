...
async function AsideContent() {
  ...
  return (
    <>
      ...
      <h6>Nous suivre</h6>
      <AsideFollowList>
        <li><Link className="fr-link fr-link--icon-left ri-bluesky-fill" target="linkedin" href={SOCIAL_NETWORKS_URL_BLUESKY ?? ''}>Bluesky</Link></li>
        ...
        <li><Link className="fr-link fr-link--icon-left ri-rss-fill" target="facebook" href={SOCIAL_NETWORKS_URL_RSS ?? ''}>Flux RSS</Link></li>
