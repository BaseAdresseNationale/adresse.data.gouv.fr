...
function Indicateurs() {
  ...
  return (
    <Page title={title} description={description}>
      ...
      <Section title='Nombre de requêtes' subtitle='en mai 2023' >
        <Image src='/images/indicateurs/nb_requetes.png' height={200} width={1000} />
      </Section>

      <Section title='Part public-privé' subtitle='en mai 2023' background='grey'>
        <Image src='/images/indicateurs/part_public.png' height={575} width={1000} />
      </Section>

      <Section title='Ils nous font confiance' subtitle='Les 5 plus gros utilisateurs publics en mai 2023'>
        <Image src='/images/indicateurs/top5.png' height={530} width={1000} />
      </Section>
