...
function Guides() {
  return (
    <Page>
      <Head title='Ressources autour de l’adressage' icon={<Book size={56} alt aria-hidden />} />
      <Section>
        <SectionText>
          <p>
      ...
      <Section background='color' title='Documentation'>
        ...
        <div className='button-container'>
          <div className='logos-container'>
            <Image src='/images/logos/BAN.svg' height={210} width={210} alt aria-hidden />
            <Image src='/images/logos/BAL.svg' height={200} width={200} alt aria-hidden />
          </div>
      ...
      <Section background='color' title='F.A.Q'>
        <div className='faq-container'>
          <div className='icon-container'>
            <Image src='/images/icons/faq.svg' height={190} width={190} alt aria-hidden />
          </div>
