...
function Accessibilite() {
  ...
  return (
    <Page title={title} description={description}>
      <Head title={title} icon={<Smile size={56} alt aria-hidden />} />

      <Section>
        <div className='accessibility-intro'>
          <div className='accessibility-illustration'>
            <Image src='/images/accessibilite-illustration.svg' layout='responsive' height={100} width={500} alt aria-hidden />
          </div>
      ...
      <Section background='color' title='État de conformité'>
        <Notification type='warning'>
          <div className='conformity'><XCircle alt aria-hidden /> Non conforme</div>
        </Notification>
