        ...
        <div className='faq-row'>
          ...
          <div className='theme'>
            ...
            <Question question='Avec quels outils peut-on créer ou gérer une Base Adresse Locale ?'>
              <p>Le site <a className='disabled'>Mes adresses</a> développé par Etalab est un outil simple, gratuit et accessible à tous.</p>
              ...
              <p>Les communautés d’agglomération, communautés urbaines, métropole, voire départements disposent bien souvent d’une gestion des adresses intégrées à leur système d’information ou d’outils spécifiques. Il leur suffit alors de produire un fichier au <Link href='/bases-locales'><a>format BAL</a></Link> et de le publier.</p>
              <p>Plusieurs éditeurs logiciels travaillent au support du format d’échange BAL, ils seront référencés sur ce site à l’issue de leurs travaux.</p>
            </Question>

            <Question question='Comment publier une Base Adresse Locale ?'>
              <p>Pour publier une Base Adresse Locale, vous devez la référencer sur <a href='https://www.data.gouv.fr/fr/'>data.gouv.fr</a>. Elle doit être publiée au format CSV BAL, dans une organisation certifiée, et avec un mot-clé “base-adresse-locale”.</p>
              <p>Conscients que cette méthode est trop complexe pour la plupart des collectivités, nous développons un module de publication simplifié qui sera disponible d’ici la fin de l’année. La fonctionnalité de publication est d’ores-et-déjà disponible pour les utilisateurs de <a className='disabled'>Mes Adresses</a>.</p>
            </Question>

            <Question question='Sous quelle licence publier une Base Adresse Locale ?'>
              <p>La <strong>DINUM</strong> et l’<strong>Association des maires de France (AMF)</strong> suggèrent activement de publier les Bases Adresses Locales sous <a href='https://www.etalab.gouv.fr/licence-ouverte-open-licence'>Licence Ouverte</a>, licence qui garantit leur utilisation la plus large.</p>
