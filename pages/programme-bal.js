...
function ProgrammeBAL({stats}) {
  ...
  return (
    <Page title={title} description={description}>
      <section className='hero-section' style={{background: 'var(--blue-france-975-75)'}}>
        <div className='fr-container fr-py-5w'>
          <div className='fr-grid-row'>
            <div className='fr-col-md-7 improve-quality-card'>
              ...
              <Button type='button' onClick={() => navigateTo('https://mes-adresses.data.gouv.fr/')} style={{color: 'white'}}>Créer la base de ma commune</Button>
            </div>
            <div className='fr-col-md-5 image-wrapper'>
              <img className='fr-responsive-img' alt='' src='/images/bal-landing-page/illustration.png' width='100%' />
            </div>
          </div>
        </div>
      </section>
