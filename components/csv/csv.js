      ...
      <Section>
        <div id='main' className='csvtogeocoder'>
          <div>
            ...
            <Holder file={file} placeholder={`Glisser un fichier ici (max ${MAX_SIZE / 1000000} Mo ou environ 15000 lignes), ou cliquer pour choisir`} onDrop={fileList => this.onDrop(fileList)} />
