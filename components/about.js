...
const About = () => (
  <div>
    <Head title='À propos' icon='/static/images/icons/about.svg'>
    ...
    <Section>
      <div className='prose'>
        ...
        <ul>
          <li>des acteurs nationaux tels que l’<a href='http://ign.fr/'>IGN</a> et <a href='http://legroupe.laposte.fr/'>La Poste</a>,</li>
        ...
        <p>Le site adresse.data.gouv.fr est développé par la mission <a href='http://www.etalab.gouv.fr/'>Etalab</a> du <a href='http://www.modernisation.gouv.fr/'>Secrétariat Général à la Modernisation de l’Action Publique</a> (SGMAP).</p>
      </div>
      <div className='prose'>
