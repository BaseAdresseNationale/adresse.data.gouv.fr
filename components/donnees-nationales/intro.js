  ...
  return (
    <div className='section-container'>
      ...
      <div className='characteristics'>
        <div>
          <h6><List style={{verticalAlign: 'bottom', marginRight: '5px'}} color={theme.primary} alt aria-hidden='true' /> Caractéristiques</h6>
          <ul>
        ...
        <div>
          <h6> <Target style={{verticalAlign: 'bottom', marginRight: '5px'}} color={theme.primary} alt aria-hidden='true' /> Chiffres clés</h6>
          <ul>
