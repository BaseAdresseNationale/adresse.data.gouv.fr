      ...
      <div className='blog-pagination' role='navigation'>
        {prev && (
          <Link href={`${href}${prev}${tags}`}>
            <a className='page' aria-label='Aller à la page précédente'><ArrowLeftCircle style={{verticalAlign: 'middle'}} alt aria-hidden /></a>
          </Link>
        )}
        {pageNumbers.map(n => (
        ...
        {next && (
          <Link href={`${href}${next}${tags}`}>
            <a className='page' aria-label='Aller à la page suivante'><ArrowRightCircle style={{verticalAlign: 'middle'}} alt aria-hidden /></a>
          </Link>
        )}
      </div>
