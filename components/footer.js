      ...
      <div className='footer-container'>
        <div className='footer__logo'>
          ...
          <ul className='footer__social'>
            ...
            <li><Link href='/blog' passHref><a aria-label='Consulter notre blog'><Image width={25} height={25} src='/images/medias/medium.svg' alt='Medium' /></a></Link></li>
            <li><Link href='/nous-contacter' passHref><a aria-label='Contacter lՎquipe'><Image width={25} height={25} src='/images/medias/envelop.svg' alt='Nous contacter' /></a></Link></li>
          </ul>
        </div>
