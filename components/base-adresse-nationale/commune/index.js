    ...
    <>
      ...
      {certificationInProgress && nbNumeros > 0 && (
        <Notification style={{marginTop: '1em'}} type='info'>
          ...
          Actuellement, <span className='non-breaking'><b>{nbNumerosCertifies} / {nbNumeros} adresses ({certificationPercentage}%) sont certifiées</b> <CheckCircle style={{verticalAlign: 'middle'}} color={theme.successBorder} size={26} alt aria-hidden /></span>.
        </Notification>
      )}
