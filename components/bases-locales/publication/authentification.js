    ...
    <div className='auth-container'>
      <div className='dropdown-container'>
        ...
        >
          ...
          {isHabilitedOpen ? <ChevronDown color={theme.primary} size={35} alt aria-hidden /> : <ChevronRight color={theme.primary} size={35} alt aria-hidden />}
        </button>
          ...
          <div className='content'>
            <div className='authentification-choice'>
              ...
              <a href={fcButtonUrl} aria-label='S’authentifier avec FranceConnect'>
                <Image width={280} height={82} layout='fixed' src='/images/FCboutons-10.svg' alt aria-hidden />
              </a>
      ...
      <div className='habilitation-explanation'>
        ...
        <ul>
          <li><Users size={15} alt aria-hidden /> <p>Permet à <b>toute personne aillant accès à l’édition</b> de cette Base Adresse Locale de <b>mettre à jour</b> les adresses de sa commune.</p></li>
          <li><Clock size={15} alt aria-hidden /> <p>Elle est valable <b>6 mois</b>.</p></li>
          <li><LogIn size={15} alt aria-hidden /> <p>Pour l’obtenir, <b>un(e) élu(e)</b> de la commune ou <b>un(e) employé(e)</b> de la mairie doit <b>s’authentifier</b>.</p></li>
        </ul>
      </div>
        ...
        {isNonHabilitedOpen && (
          <div className='content'>
            <div className='infos-habilitation'>
              <h4><Info alt aria-hidden /><b>Prestataires et délégataires</b></h4>
