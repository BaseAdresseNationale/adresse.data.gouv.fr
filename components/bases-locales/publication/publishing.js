      ...
      <div className='message'>
        ...
        {hasConflit && (
          <Notification type='warning'>
            <div className='alert-content'>
              <h4><AlertOctagon alt='' aria-hidden='true' /> Une autre Base Adresses Locale est déjà synchronisée avec la Base Adresses Nationale.</h4>
        ...
        <div>
          ...
          <Button size='large' disabled={hasConflit && !isConfirmed} onClick={publication}>
            <div className='publish-button-content'><ArrowUpCircle size={25} alt='' aria-hidden='true' /> Publier</div>
          </Button>
        </div>
      </div>
