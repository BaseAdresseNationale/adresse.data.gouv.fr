        ...
        <div className='modal-content'>
          <div className={`left-content ${type}`}>
            ...
            {isOnlineOnly ? (
              ...
              <div><MapPin strokeWidth={3} size={14} style={{marginRight: 5}} alt aria-hidden />{nom}, {numero} {voie} - {codePostal} {commune}</div>
            )}
          ...
          <div className='right-content'>
            <div className='head-container'>
              <Image src={`/images/icons/event-${type}.svg`} height={60} width={60} alt aria-hidden />
