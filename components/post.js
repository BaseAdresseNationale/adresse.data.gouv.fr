...
function Post({title, published_at, feature_image, authors, html, backLink}) {
  ...
  return (
    <Section>
      <Link href={backLink}>
        <a className='blog-back-button'><ArrowLeftCircle size={25} style={{verticalAlign: 'middle', marginRight: '.5em'}} alt aria-hidden /> Retour</a>
      </Link>
      ...
      <div className='blog'>
        ...
        {feature_image && (
          <div className='blog-feature-image-container'>
            <Image src={feature_image} layout='fill' objectFit='cover' className='blog-feature-image' alt aria-hidden />
          </div>
        )}
